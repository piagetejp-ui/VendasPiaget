# Guia de ativação de segurança — RC2.7.11

## Regra de ouro

**Domínio e código primeiro. Firestore Rules depois.**

## Etapa 1 — verificar domínio já configurado

A configuração usada e já validada para o domínio é:
...
Antes de avançar, confirme que a Vercel continua mostrando configuração válida/HTTPS ativo.
...
## Etapa 4 — publicar e testar RC2.7.11 mantendo as Rules atuais
