...
/* Escola Piaget — V1.6.0-rc2.4-caixa-responsabilidade
   Inicialização única. Nenhuma função histórica é redirecionada após o login. */
const APP_VERSION_CLEAN='1.6.0-rc2.4-caixa-responsabilidade';
...
async function startApplicationClean(){
  ...
  await boot();
  // boot pode ter aberto redefinição de senha ou uma sessão autenticada da equipe.
