...
async function markChangedEntitiesV221(action,data,responsavelId,auditId,entities,now){
  ...
  const base={ultimaAcao:action,ultimaAuditoriaId:auditId||null,ultimaAlteracaoEm:now,processada:false,versao:'1.6.0-rc2.7.31'};
