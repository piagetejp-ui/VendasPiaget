# Escola Piaget — Sistema de Vendas V1.5.0-dev5.1-logo-hotfix
...
2. Envie **todo o conteúdo da pasta** `vendas-piaget-v1.5.0-dev5.1-logo-hotfix` para o projeto da Vercel.
...
- JavaScript e CSS ficam em uma pasta física exclusiva da versão:
  `/releases/1.5.0-dev5.1-logo-hotfix/`.
...
- `releases/1.5.0-dev5.1-logo-hotfix/`: CSS e JavaScript físicos da versão.
- `api/`: APIs Vercel e hotfix financeiro.
- `vercel.json`: regras de cache.


## Hotfix de logo — V1.5.0-dev5.1-logo-hotfix
