...
module.exports=async function(req,res){
  ...
  try{
    ...
    if(acao==='family_audit'){
      ...
      await db.collection('historico_auditoria').add({acao:action,dados:safe,usuarioId:`responsavel:${s.responsavelId}`,usuarioNome:'Responsável',usuarioPerfil:'responsavel',responsavelId:s.responsavelId,criadoEm:nowIso(),versao:'1.6.0-rc2.7.16'});
