...
const {initFirebase,json,parseBody,nowIso,normalizeSecretarySaleItems}=require('./_utils');
...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    if(['venda_catalogo','venda_imediata'].includes(op)){
      const normalized=await normalizeSecretarySaleItems(db,items,'online');
