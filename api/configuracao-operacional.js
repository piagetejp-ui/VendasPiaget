...
async function saveSystemConfig(db,body,actor){
  ...
  const cfgPatch={limiteMaximoFiadoCentavos:baseLimit,valorMinimoCheckoutPositivoCentavos:minCredit,quantidadePadraoSalgados:defaultSnacks,bloqueioSemanalSaldoAtivo:weekly,diaBloqueioSemanalSaldo:'sexta',versao:'1.6.0-rc2.7.24',atualizadoEm:now};
