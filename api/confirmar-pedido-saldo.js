const {initFirebase,json,parseBody,buildCheckoutOperation,confirmCantinaOrderWithoutCheckout,confirmUniformOrderWithoutCheckout,nowIso}=require('./_utils');
...
module.exports=async function handler(req,res){
  ...
  try{
    ...
    const perfil=String(body.criadoPorPerfil||body.usuarioPerfil||'responsavel');if(perfil==='responsavel')await verifyFamilyForStudent(db,req,body.alunoId);
